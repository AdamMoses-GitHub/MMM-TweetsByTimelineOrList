...
module.exports = NodeHelper.create({
    ...
    start: function () {
        console.log(this.name + " #### loaded node helper");
        this.moduleConfigs = [];
        this.timers = [];
        this.errorCount = 0;
    ...
    updateTweets: function (theConfig) {
        ...
        if ((theConfig.listToShow.toUpperCase() === 'SEARCH')) {
            ...
            if ((theConfig.listToShow === '') || (theConfig.listToShow.toUpperCase() === 'TIMELINE')) {
            ...
            // otherwise get a named list
                ...
                params = {
                    count: theConfig.totalTweetsPerUpdate, exclude_replies: true, include_rts: false,
        ...
        client.get(query, params, function (error, tweets, response) {
            ...
            if (!error) {
                ...
                //if we are searching we need a little preprocessing
